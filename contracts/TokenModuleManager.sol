...
<<<<<<< HEAD
    ...
    function TokenModuleManager(){
        ...
        _json = _json.concat("\"moduleUrl\":\"http://112.64.159.162:6730/dapp-token/#\"", ",");
        ...
        if(isExists != 1){
            log("publish token module , exec update ...");
            ret = updModule(_json); 
            sysModuleId = ret.recoveryToString();
        } else {
            log("publish token module , exec insert ...");
            ret = addModule(_json); 
            sysModuleId = ret.recoveryToString();
        } 
...
>>>>>>> d16b4918ce0dafb52bf53062c0b06470ecab9b7c
